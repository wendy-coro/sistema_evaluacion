...
public final class nuevo_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Iterator<Programa> itPrograma=lista.iterator();
      ...
      out.write("        <title>Nueva Venta</title>\n");
      out.write("        \n");
      out.write("    </head>\n");
      out.write("    <body>        \n");
      out.write("            <form method=\"POST\"  action=\"procesa_nuevo.jsp\">\n");
      out.write("            <input type=\"text\" class=\"form-control\" placeholder=\"Nombre Coordinador\" required id=\"nombre\" name=\"nombre\"/>\n");
      out.write("            <input type=\"text\" class=\"form-control\" placeholder=\"Apellido Coordinador\" required id=\"nombre\" name=\"apellido\"/>\n");
      out.write("            <input type=\"text\" class=\"form-control\" placeholder=\"Cedula Coordinador\" required id=\"nombre\" name=\"cedula\"/>\n");
