...
public final class listar_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Iterator<Estudiante> itEstudiante=lista.iterator();
      ...
      out.write("        \n");
      out.write("        <title>Estudiantes</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
...
while(itEstudiante.hasNext()){
      ...
      out.write("</td>\n");
      out.write("                    <td>");
      out.print(estudiante.getNombre());
      out.write("</td>\n");
      out.write("                    <td>");
      out.print(estudiante.getApellido());
      out.write("</td>\n");
      out.write("                    <td>");
      out.print(estudiante.getCedula());
      out.write("</td>\n");
      out.write("                    <td>");
      out.print(estudiante.getPrograma());
      out.write("</td>  \n");
      out.write("                    <td>");
      out.print(estudiante.getFecha());
      out.write("</td>  \n");
      out.write("                   <td>\n");
      ...
      out.write("                        <h5 class=\"modal-title\" id=\"exampleModalLabel\">Editar Estudiante</h5>\n");
      ...
      out.write("                <div class=\"modal-content\">\n");
      out.write("                      <div class=\"modal-header\">\n");
      out.write("                        <h5 class=\"modal-title\" id=\"exampleModalLabel\">Nuevo Estudiante</h5>\n");
      out.write("                        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n");
      out.write("                          <span aria-hidden=\"true\">&times;</span>\n");
      out.write("                        </button>\n");
      out.write("                      </div>\n");
