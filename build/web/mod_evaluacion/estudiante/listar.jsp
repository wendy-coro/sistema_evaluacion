...
<%      
 List<Estudiante> lista=Estudiante.estudiante_buscartodos();
       ...
       <% }%>
        ...
        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">                <thead>
               ...
               <%while(itEstudiante.hasNext()){
                ...
                <tr>
                   <td><%=estudiante.getEstudianteid()%></td>
                    <td><%=estudiante.getNombre()%></td>
                    <td><%=estudiante.getApellido()%></td>
                    <td><%=estudiante.getCedula()%></td>
                    <td><%=estudiante.getPrograma()%></td>  
                    <td><%=estudiante.getFecha()%></td>  
                   <td>
                         <a class="btn btn-danger" href='procesa_eliminar.jsp?codigo=<%= estudiante.getEstudianteid()%>' onclick="return confirm('¿Está seguro que desea eliminar este registro?');">Eliminar</a>
                      <button type="button"  onclick="return modaleditar(<%= estudiante.getEstudianteid()%>)" class="btn btn-primary" data-toggle="modal" data-target="#ModalEditar">Editar</button>  
