...
<html>
	...
	<link rel="stylesheet" href="https://cdn.datatables.net/responsive/2.2.3/css/responsive.bootstrap4.min.css">
        ...
        <title>Preguntas Coordinador</title>
    </head>
    ...
    if (alerta.equals("si")){%>
     ...
     <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
               ...
               <%while(itPreguntas_Coordinador.hasNext()){
                  Preguntas_Coordinador programa=itPreguntas_Coordinador.next();%>
                <tr>
                   <td><%= programa.getPreguntas_cid()%></td>
                   <td><%= programa.getPregunta()%></td>
        
                   <td>
                         <a class="btn btn-danger" href='procesa_eliminar.jsp?codigo=<%= programa.getPreguntas_cid()%>' onclick="return confirm('¿Está seguro que desea eliminar este registro?');">Eliminar</a>
                         <button type="button"  onclick="return modaleditar(<%= programa.getPreguntas_cid()%>)" class="btn btn-primary" data-toggle="modal" data-target="#ModalEditar">Editar</button>  
