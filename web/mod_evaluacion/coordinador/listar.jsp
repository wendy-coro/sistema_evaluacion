<%-- 
    Document   : listar
    Created on : 21-ago-2019, 11:18:33
    Author     : marco
--%>
...
<%
 ...
 Iterator<Coordinador> itCoordinador=lista.iterator();
%>
<!DOCTYPE html>
<html>
    <head>
       ...
       <% }%>
        ...
        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">                <thead>
               ...
               <%while(itCoordinador.hasNext()){
                ...
                <tr>
                   <td><%=coordinador.getCoordinadorid()%></td>
                    <td><%=coordinador.getNombre()%></td>
                    <td><%=coordinador.getApellido()%></td>
                    <td><%=coordinador.getCedula()%></td>
                    <td><%=coordinador.getPrograma()%></td>
                    <td><%=coordinador.getFecha()%></td>
                    
                 <td>
                      <a class="btn btn-danger" href='procesa_eliminar.jsp?codigo=<%= coordinador.getCoordinadorid()%>' onclick="return confirm('¿Está seguro que desea eliminar este registro?');">Eliminar</a>
                      <button type="button"  onclick="return modaleditar(<%= coordinador.getCoordinadorid()%>)" class="btn btn-primary" data-toggle="modal" data-target="#ModalEditar">Editar</button>  
            ...
            <div class="modal fade" id="ModalEditar" class="" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Editar Coordinador</h5>
